...
def add_damage(image, damage_type="noise", intensity=0.3, severity="medium"):
    ...
    Args:
        ...
        intensity: 破壞強度 (0.0-1.0, 保留向後相容性)
        severity: 破壞等級 - "light", "medium", "heavy"
    
    Damage Effects:
        - Noise: 椒鹽噪聲 + 輕微高斯噪聲，模擬掃描雜訊和霉點
        - Erosion: 形態學侵蝕，模擬筆畫風化和斷裂
        - Occlusion: 多個遮擋區域，模擬墨水污漬和紙張破損
    """
    damaged = image.copy()
    h, w = image.shape
